...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_boolean_logic__ = __webpack_require__(2);
...
onmessage = e => {
  ...
  if (bruteChecked) {
    ...
    bruteModel = __WEBPACK_IMPORTED_MODULE_0_boolean_logic__["a" /* default */].isSat(wff, true, true);
  ...
  if (shortChecked) {
    const beforeTime = new Date();
    shortModel = __WEBPACK_IMPORTED_MODULE_0_boolean_logic__["a" /* default */].isSat(wff, true, false);
    const afterTime = new Date();
  ...
  if (bruteChecked) {
    postData.brute = {
      wff,
      numAtomics: __WEBPACK_IMPORTED_MODULE_0_boolean_logic__["a" /* default */]._atomics(wff).length,
      algorithm: 'brute',
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__class_definition_js__ = __webpack_require__(7);
...
/***/ })
/******/ ]);
//# sourceMappingURL=88cb2e23e546118844c6.worker.js.map