...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_boolean_logic___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_boolean_logic__);
...
onmessage = e => {
  ...
  if (bruteChecked) {
    ...
    bruteModel = __WEBPACK_IMPORTED_MODULE_0_boolean_logic__["default"].isSat(wff, true, true);
  ...
  if (shortChecked) {
    const beforeTime = new Date();
    shortModel = __WEBPACK_IMPORTED_MODULE_0_boolean_logic__["default"].isSat(wff, true, false);
    const afterTime = new Date();
  ...
  if (bruteChecked) {
    postData.brute = {
      wff,
      numAtomics: __WEBPACK_IMPORTED_MODULE_0_boolean_logic__["default"]._atomics(wff).length,
      algorithm: 'brute',
      version: '1.1.2',
...
"use strict";
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open '/Users/matthiasjenny/GoogleDrive/Projects/sat-zoo/node_modules/boolean-logic/boolean-logic.js'\n    at Error (native)");
...
/***/ })
/******/ ]);
//# sourceMappingURL=8ec0eede2b90cc1a42a4.worker.js.map